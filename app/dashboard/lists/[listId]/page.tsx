        ...
        <div className="lg:col-span-1 flex flex-col min-h-0">
          ...
          <div className="sticky top-0 z-30 bg-[#f1f5f9] dark:bg-[#080c14] py-3 border-b border-slate-200 dark:border-slate-800 mb-3 space-y-2">
            ...
            {selectedPageIds.length > 0 && (
              <div className="p-2.5 rounded-2xl bg-blue-500/10 border border-blue-500/30 text-blue-700 dark:text-blue-300 flex items-center justify-between gap-2 text-xs font-bold animate-in fade-in duration-150 shadow-sm">
