export const COMPANY_COLOR_THEMES = [
  ...
  },
  {
    ...
    borderHex: '#d946ef',
    bgLight: 'rgba(217, 70, 239, 0.11)',
    borderLight: 'rgba(217, 70, 239, 0.35)',
