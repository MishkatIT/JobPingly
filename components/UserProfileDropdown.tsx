...
import { LayoutDashboard, Briefcase, Settings, ShieldAlert, LogOut, ChevronDown } from 'lucide-react';
...
export function UserProfileDropdown({ user, onLogout, direction = 'down' }: UserProfileDropdownProps) {
